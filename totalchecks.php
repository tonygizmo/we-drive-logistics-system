...
<head>
  <meta charset="UTF-8">
  <title>Total Vehicle Checks | We-Drive</title>
  ...
  <div class="row">
    ...
    <main class="col-md-10 ms-sm-auto px-4">
      ...
      <div class="d-flex justify-content-between flex-wrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Completed Vehicle Checks</h1>
        <a href="vehiclecheckdashboard.php" class="btn btn-secondary">Back to Vehicle Dashboard</a>
      </div>
          ...
          <table class="table table-bordered table-striped align-middle">
            ...
            <tbody>
              <?php while ($row = mysqli_fetch_assoc($result)): ?>
                ...
                $hasFailed = ($row['defects_found'] == 1 || $row['vehicle_safe_to_use'] == 0 || count($failedItems) > 0);
                ?>

                <tr class="<?= $hasFailed ? 'table-danger' : ''; ?>">
