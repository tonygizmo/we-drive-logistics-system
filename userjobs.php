              ...
              <div class="card rounded-3 text-black">
                <div class="row g-0">
                    ...
                    <div class="text-center">
                        <img src="images/logo.png" 
                          ...
                          <p>
                            ...
                            <a href="usercomplete.php" class="btn btn-danger mt-3">Completed Jobs</a>
                        </p>
                      </div>
                 ...
                 <div class="single-product-item">
                                ...
                                $sql = "SELECT * FROM jobs WHERE driver LIKE '$user' AND complete LIKE '0'";
                ...
                <td>
                   <div class="more-info">
																			<form method="POST" action= "<?PHP echo $_SERVER['PHP_SELF']; ?>" >
																						...
																						<input type="hidden" name="pID" value="<?php  echo $row['jobNumber'] ?>"></input>
																						<input type="submit" name="submit" value="info"></input>
																						<br>
																			</form>
                                    </td>
...
<!--
                    ...
                    <div class="px-3 py-4 p-md-5 mx-md-4" style="background-color: rgb(99, 95, 95); width:100%; height:90%; ">
                    <h4> Active Jobs Details</h4>
                    <h6> Return active job details here </h6>
                    <div class="text-black" >

                    set a session - hold the job id within session, return the details for highlighted job to this side 
                        refresh page each time new job is selected and update the session details. 

                       <ul class="list-group text-black">
                                
                                <li class="list-group-item">Collection Address</li>
                                <li class="list-group-item">Delivery Address</li>
                                <li class="list-group-item">Collection Date / collection time</li>
                                <li class="list-group-item">Vehicle Make</li>
                                <li class="list-group-item">Vehicle Model</li>
                        </ul>
</div>
                                
                                <p>
                            
                            <a href="welcome.php" class="btn btn-danger mt-3">Back</a>
                        </p>
