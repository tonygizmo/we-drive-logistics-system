...
// this page passes the job number and details, requests data from a checklist, 
//on completion the data is sent through a $get request to the action page, this formats the data and creates a new check field in the table. 
