...
<html lang="en">
  ...
  <body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    <div class="form-group">
            <input type="hidden" name="username" value="testuser"></input>
            <input type="hidden" name="password" value="testuser12"></input>
            <input type="submit" class="btn btn-primary" value="Test User Login">
            </div>
      </form>
