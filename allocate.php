  ...
  <body>
    ...
    <!-- END nav -->
      ...
      <section class="mt-20 h-100 gradient-form" style="background-color: rgb(5, 5, 5);">
        <div class="container py-5 h-100 " style="margin: 0px 50px 0px 50px; padding-top: 10% !important;">
            ...
            <div class="col-xl-12">
              <div class="card rounded-3 text-black">
                ...
                <td> <?php echo $driver ?> </td>
                        ...
                        <td><select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id="driver" onchange="setDriver()">
                            <option selected>Allocate Driver</option>
...
<?php } ?> 
                <td>
                   ...
                   <script>
                                    ...
                                    window.location.href = "update.php?name=" + driver; 
